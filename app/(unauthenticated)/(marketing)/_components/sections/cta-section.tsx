  ...
  return (
    <SectionWrapper>
      <div className="mx-auto max-w-2xl text-center">
        ...
        >
          Ready to secure your network with LeiaGuard?
        </motion.h2>
        <motion.p
        ...
        >
          Clone LeiaGuard and take full control of your WireGuard VPN in minutes.
        </motion.p>
        <motion.div
        ...
        >
          ...
          >
            <Link
              href="https://github.com/YOUR_ORG/LeiaGuard"
              target="_blank"
            >
